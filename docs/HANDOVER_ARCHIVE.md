# Artdle Web — Handover · Archive

Older wave entries (2026-05-24 and earlier, plus the v2.0 / v1.1 / v1.0 historical sections) moved here from `HANDOVER.md` on 2026-05-31 to keep the active handover readable. Newest-first, unchanged.

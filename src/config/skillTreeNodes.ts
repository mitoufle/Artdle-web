...
export const SKILL_NODES: ReadonlyArray<SkillNodeConfig> = [
  { id: "get_inspired", name: "Get Inspired", description: "each level increase inspiration gain by 25%", numericEffect: "25%", parentIds: [], stacking: "additive", kind: "minor", maxLevel: 5, costs: [1, 2, 3, 5, 8], unlocks: [] },
  { id: "black_white", name: "Black & White", description: "canvas sell price increase by 20%", numericEffect: "20%", parentIds: ["basic_technique"], stacking: "additive", kind: "minor", maxLevel: 1, costs: [3], unlocks: [] },
  { id: "magenta", name: "Magenta", description: "canvas sell price increase by 30%", numericEffect: "30%", parentIds: ["black_white"], stacking: "additive", kind: "minor", maxLevel: 1, costs: [8], unlocks: [] },
  { id: "cyan", name: "Cyan", description: "canvas sell price increase by 30%", numericEffect: "30%", parentIds: ["black_white"], stacking: "additive", kind: "minor", maxLevel: 1, costs: [8], unlocks: [] },
  { id: "yellow", name: "Yellow", description: "canvas sell price increase by 30%", numericEffect: "30%", parentIds: ["black_white"], stacking: "additive", kind: "minor", maxLevel: 1, costs: [8], unlocks: [] },
  { id: "red", name: "Red", description: "canvas sell price increase by 40%", numericEffect: "40%", parentIds: ["magenta", "yellow"], stacking: "additive", kind: "minor", maxLevel: 1, costs: [20], unlocks: [] },
  { id: "green", name: "Green", description: "canvas sell price increase by 40%", numericEffect: "40%", parentIds: ["yellow", "cyan"], stacking: "additive", kind: "minor", maxLevel: 1, costs: [20], unlocks: [] },
  { id: "blue", name: "Blue", description: "canvas sell price increase by 40%", numericEffect: "40%", parentIds: ["cyan", "magenta"], stacking: "additive", kind: "minor", maxLevel: 1, costs: [20], unlocks: [] },
  { id: "purple", name: "Purple", description: "canvas sell price increase by 50%", numericEffect: "10%", parentIds: ["blue", "red"], stacking: "additive", kind: "minor", maxLevel: 1, costs: [50], unlocks: [] },
  { id: "brown", name: "Brown", description: "canvas sell price increase by 50%", numericEffect: "10%", parentIds: ["green", "blue"], stacking: "additive", kind: "minor", maxLevel: 1, costs: [50], unlocks: [] },
  { id: "orange", name: "Orange", description: "canvas sell price increase by 50%", numericEffect: "10%", parentIds: ["red", "green"], stacking: "additive", kind: "minor", maxLevel: 1, costs: [50], unlocks: [] },
  { id: "rainbow", name: "Rainbow", description: "Canvas sell price increase by 50%", numericEffect: "50%", parentIds: ["orange", "brown", "purple"], stacking: "multiplicative", kind: "major", maxLevel: 1, costs: [150], unlocks: [] },
  ...
  { id: "basic_technique", name: "Basic Technique", description: "canvas completion time is 2% faster.", numericEffect: "2%", parentIds: [], stacking: "additive", kind: "minor", maxLevel: 5, costs: [1, 2, 3, 4, 5], unlocks: [] },
  ...
  { id: "taylorsim", name: "Taylorism", description: "Autocraft an Item every 10s. ", numericEffect: "1", parentIds: ["shredder"], stacking: "additive", kind: "minor", maxLevel: 1, costs: [120], unlocks: [] },
  ...
  { id: "consistency", name: "Consistency", description: "increases crit chance by 1%", numericEffect: "1", parentIds: ["genius_episode"], stacking: "additive", kind: "minor", maxLevel: 5, costs: [20, 35, 60, 100, 160], unlocks: [] },

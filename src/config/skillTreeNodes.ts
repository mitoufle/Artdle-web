...
export const SKILL_NODES: ReadonlyArray<SkillNodeConfig> = [
  ...
  { id: "food_regulation", clusterId: "office", name: "Food regulation", description: "newly-hired workers gain +1 to every base stat (+1% crit chance).", numericEffect: "1", parentIds: ["entrepreneur"], stacking: "additive", kind: "minor", maxLevel: 1, costs: [1200], unlocks: ["worker_food_regulation"] },
  ...
  { id: "handcrafted_brush", clusterId: "office", name: "Handcrafted Brush", description: "newly-hired workers gain +3% stroke speed base stat per level.", numericEffect: "3%", parentIds: ["hire_manager"], stacking: "additive", kind: "minor", maxLevel: 5, costs: [10000, 15000, 20000, 25000, 35000], unlocks: ["worker_speed_per_level"] },
